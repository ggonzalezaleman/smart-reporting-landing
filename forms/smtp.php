...
$sendConfirmationToUser    = false;    // leave false to disable confirmation, set to true to enable.
$userEmailField            = "email";  // What part of form data to use as an address to send confirmation email.
$userNameField             = "name";   // What part of form data to use as the user's name on confirmation email.
...
//    "[[contact-name]]"     => ucfirst($_POST["ask-name"]),
